...
const BY_ROLE = {
  ...
  factory: [
    ...
    {
      id: 'factory-solar',
      title: `Solar generation ${FACTORY.energy.solar.comparison.pct}% of trailing average`,
      detail: 'Check for shading, panel soiling or an inverter fault.',
      when: '1 hour ago',
      to: 'energy',
    },
    {
      id: 'factory-withering',
      title: 'Withering trough 2 running long',
      detail: '2 h over standard cycle — leaf condition being watched.',
      when: '3 hours ago',
      to: 'processing',
    },
  ],
